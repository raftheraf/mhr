  ...
  <center>
    <table class="tabella_ordini_cassieri" width="1200">
      ...
      <tr>
        ...
        <td width=450px align="center" valign="middle">{horizontal_navbar}</td>
        <td width=450px align="center" valign="middle"><div class="tabella_ordini_messaggi">{messages}</div></td>
      </tr>
