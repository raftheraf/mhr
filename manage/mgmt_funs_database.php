...
//		echo("<META HTTP-EQUIV=\"Refresh\" CONTENT=\"0; URL=javascript:window.close();\">");
	...
	if ($num_affected==1) {
		...
		if($type=="fattura" && $input_data['paid']) {
			...
			$payment_data['description']=$invoice_data['description']." - Pagamento.";
...
//$type_name=get_db_data(__FILE__,__LINE__,$_SESSION['common_db'],'mgmt_people_types','name',$query_value);
	...
	case 6:
		...
		//provo ad introdurre il caso di conti in sopseso con tipo_corrispettivo=1
	case 7:
		$page="db.php?";
		$query.=" WHERE `tipo_corrispettivo`='T4'";
		$query.=" AND";
		$query.= " `date` >= ".$_SESSION['timestamp']['start']." AND `date` <= ".$_SESSION['timestamp']['end']."";
		$query.= " ORDER BY `$orderby`";
...
?>
	<tr align="center">
		...
		<th scope=col colspan=3 valign=middle>CLIENTE</th>
...
<?php		}
		...
		//OCCHIO NON Può fare i totali non può sommare cognomi e codici clienti
		echo "<td align=center>".$customer_id."</td>\n";
		echo "<td align=center>".$takeaway_surname."</td>\n";
		echo "<td align=center>".$tavolo_numero."</td>\n";
		echo "<td align=center>".$tipo_corrispettivo."</td>\n";
		echo "<td align=right>".$cash_plus_amount."</td>\n";
		echo "<td align=right>".$cash_minus_amount."</td>\n";
		echo "<td align=right>".$cash_vat_amount."</td>\n";
		echo "<td align=right>".$bank_plus_amount."</td>\n";
		echo "<td align=right>".$bank_minus_amount."</td>\n";
		echo "<td align=right>".$bank_vat_amount."</td>\n";
		echo "<td align=right>".$debit_amount."</td>\n";
		echo "<td align=right>".$debit_vat_amount."</td>\n";
		echo "</tr>\n";
		$i++;
...
?>
	...
	<tr align="center">
		...
		<td><b><?php echo ucfirst(phr('INCOMINGS')); ?></b></td>
		<td><b><?php echo ucfirst(GLOBALMSG_OUTGOING_MANY); ?></b></td>
		<td><b><?php echo ucfirst(phr('TAXES')); ?></b></td>
		<td><b><?php echo ucfirst(phr('INCOMINGS')); ?></b></td>
		<td><b><?php echo ucfirst(GLOBALMSG_OUTGOING_MANY); ?></b></td>
		<td><b><?php echo ucfirst(phr('TAXES')); ?></b></td>
		<td><b><?php echo ucfirst(phr('AMOUNT')); ?></b></td>
		<td><b><?php echo ucfirst(phr('TAXES')); ?></b></td>
	</tr>
...
<?php		}
		...
		*/
		...
		echo "<td>".$date["day"]."/".$date["month"]."/".$date["year"]."
			  <br><div class=\"font13px\">"
			  .$date["hour"].":".$date["minute"].":".$date["second"].
			  "</div></td>\n";
		echo "<td align=center>".$who."</td>\n";
	...
	if($row['internal_id']!="" && $row['annulled']==1) {
		...
		echo "<td align=center>".$customer_id."</td>\n";
		echo "<td>".$takeaway_surname."</td>\n";
		echo "<td align=center>".$tavolo_numero."</td>\n";
		echo "<td align=center>".$descrizione_tipo_corrispettivo." - ".$tipo_corrispettivo."</td>\n";
		echo "<td align=right>".$cash_plus_amount."</td>\n";
		echo "<td align=right>".$cash_minus_amount."</td>\n";
		echo "<td align=right>".$cash_vat_amount."</td>\n";
		echo "<td align=right>".$bank_plus_amount."</td>\n";
...
<table class="mgmt_main_table" width="100%">
	...
	<tr>
		...
		<th scope=col>Tipo di Corrispettivo</th>
...
?>
	<tfoot>
		...
		<td></td>
		<td></td>
		<td align=right><b><?php echo ucfirst(phr('TOTAL')); ?></b></td>
		<td align=right><b><?php echo $cash_total_plus_amount; ?></b></td>
		<td align=right><b><?php echo $cash_total_minus_amount; ?></b></td>
		<td align=right><b><?php echo $cash_total_vat_amount; ?></b></td>
		<td align=right><b><?php echo $bank_total_plus_amount; ?></b></td>
		<td align=right><b><?php echo $bank_total_minus_amount; ?></b></td>
		<td align=right><b><?php echo $bank_total_vat_amount; ?></b></td>
		<td align=right><b><?php echo $debit_total_amount; ?></b></td>
		<td align=right><b><?php echo $debit_total_vat_amount; ?></b></td>
		<td align=right></td>
		</tr>
	</tfoot>
	</tbody>
