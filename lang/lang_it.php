...
*/
define('GLOBALMSG_CONFIG_FILE_NOT_WRITEABLE','Il file di configurazione (conf/config.inc.php) non è scrivibile. My Handy Restaurant non può funzionare senza quel file.<br>Controllare che il file esista e sia scrivibile o che la directory conf/ sia scrivibile.<br>Ricorda che il file o la directory devono essere scrivibile per l\'utente sotto il quale gira il web server.');
...
define('GLOBALMSG_DB_CONNECTION_ERROR','Errore: Si è verificato un errore nella connessione al server del database: provare a controllare il file config.php e se il database sia attivo.');
define('GLOBALMSG_DB_NO_TABLES_ERROR','Errore: Non è presente alcuna tabella nel database, impossibile procedere.');
define('GLOBALMSG_NO_ACCOUNTING_DB_FOUND','Errore: non c\'è alcun database per la contaiblità;, impossbile procedere.<br>My Handy Restaurant ha bisogno di un database comune e almeno un database contabilità.');

define('GLOBALMSG_ACTION_IS_DEFINITIVE','L\'azione è <b>definitiva</b>');
...
define('GLOBALMSG_RECEIPT_ANNULLED_RECEIPT','La ricevuta è stata annullata');
define('GLOBALMSG_RECEIPT_ANNULLED_INVOICE','La fattura è stata annullata');
define('GLOBALMSG_RECEIPT_ANNULLED_BILL','Lo scontrino è stato annullato');
define('GLOBALMSG_RECEIPT_ANNULL_CONFIRM','Sei sicuro di voler cancellare le seguenti voci e tutte le voci di log associate?<br>L\'operazione è <b>irreversibile</b>.');
...
define('GLOBALMSG_RECORD_NONE_SELECTED_ERROR','Non è stata selezionata alcuna voce');
define('GLOBALMSG_RECORD_NONE_FOUND_ERROR','Non è stata trovata alcuna voce');
define('GLOBALMSG_RECORD_NONE_FOUND_PERIOD_ERROR','Non è stata trovata alcuna voce nel periodo richiesto');
...
define('GLOBALMSG_RECORD_DELETE_OK','è stata cancellata correttamente');
define('GLOBALMSG_RECORD_DELETE_OK_FROM_LOG','è stata cancellata correttamente dal log');
define('GLOBALMSG_RECORD_DELETE_NONE','Nessuna voce è stata selezionata');
define('GLOBALMSG_RECORD_ADD_OK','è stata aggiunta correttamente');
define('GLOBALMSG_RECORD_ADD_NONE','Nessuna voce è stata aggiunta');
define('GLOBALMSG_RECORD_EDIT_OK','è stata modificata correttamente');
define('GLOBALMSG_RECORD_EDIT_NONE','No voice has been updated');
define('GLOBALMSG_RECORD_EDIT_NOT_DONE','Nessuna voce è stata modificata');
...
define('GLOBALMSG_STOCK_ADD_ERROR','Si è verificato un errore durante l\'inserimento del nuovo prodotto');
...
define('GLOBALMSG_STOCK_MOVEMENT_NONE_ASSOCIATED_TO_INVOICE','Nessun movimento di magazzino è associato alla fattura');
...
define('GLOBALMSG_TABLE_NONE_FOUND','Non è stato trovato nessun tavolo');
define('GLOBALMSG_TABLE_NONE_SELECTED','Non è stato selezionato nessun tavolo');
...
define('GLOBALMSG_WAITER_NONE_FOUND','Non è stato trovato nessun cameriere');
define('GLOBALMSG_WAITER_NONE_SELECTED','Non è stato selezionato nessun cameriere');
