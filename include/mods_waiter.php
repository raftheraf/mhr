...
function mods_quantity ($ord) {
	...
	$output = '<table><tr><td valign="middle">'.ucfirst(phr('QUANTITY_TO_MODIFY')).''."\n";
	$output .= '<SELECT NAME="data[quantity]" SIZE="4" class="button_big">'."\n";
...
<table>
	...
	foreach ($ord->ingredients['contained'] as $name => $ingredid) {
		...
		<tr style="height:40px;">
			<td><input type="checkbox" name="data[ingreds]['.$ingredid.']" value="'.$ingredid.'" checked class="radio_small"></td>
			<td onClick="check_elem(\'form1\',\'data[ingreds]\','.$ingredid.');return false;">'.ucfirst($name).' '.$price.'</td>
			<td><input type="radio" name="data[ingred_qty]['.$ingredid.']" value="1"'.$checked_lot.' class="radio_small"></td>
			<td onClick="check_ingredqty('.$ingredid.',0);return false;">+&nbsp;&nbsp;</td>
			<td><input type="radio" name="data[ingred_qty]['.$ingredid.']" value="0"'.$checked_normal.' class="radio_small"></td>
			<td onClick="check_ingredqty('.$ingredid.',1);return false;">=&nbsp;&nbsp;</td>
			<td><input type="radio" name="data[ingred_qty]['.$ingredid.']" value="-1"'.$checked_few.' class="radio_small"></td>
...
<table>
	...
	foreach ($ord->ingredients['available'] as $name => $ingredid) {
		...
		$output .= '
		<tr style="height:40px;">
			<td><input type="checkbox" name="data[ingreds]['.$ingredid.']" value="'.$ingredid.'" class="radio_small"></td>
			<td onClick="check_elem(\'form1\',\'data[ingreds]\','.$ingredid.');return false;">'.ucfirst($name).' '.$price.'</td>
			<td><input type="radio" name="data[ingred_qty]['.$ingredid.']" value="1" class="radio_small"></td>
			<td onClick="check_ingredqty('.$ingredid.',0);return false;">+&nbsp;&nbsp;</td>
			<td><input type="radio" name="data[ingred_qty]['.$ingredid.']" value="0" checked class="radio_small"></td>
			<td onClick="check_ingredqty('.$ingredid.',1);return false;">=&nbsp;&nbsp;</td>
			<td><input type="radio" name="data[ingred_qty]['.$ingredid.']" value="-1" class="radio_small"></td>
			<td onClick="check_ingredqty('.$ingredid.',2);return false;">-</td>
		</tr>';
...
function mods_letter_list ($ord) {
	...
	$output .= '<b class="listmods_tutto"><a href="#" onclick="JavaScript:mod_set(\'ALL\'); return false;">'.ucfirst(phr('ALL')).'</a></b><br><br>'."\n";
	foreach ($letters as $char) {
		$output .= '<b class="listmods_tutto"><a href="#" onclick="JavaScript:mod_set(\''.$char.'\'); return false;">'.$char.'</a></b>&nbsp;&nbsp;'."\n";
...
function mods_list($start_data,$letter='') {
	...
	//javascript che permette di selezionare in base alle lettere della tastiera
